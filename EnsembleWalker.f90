...
module EnsembleWalkerModule
    ...
    end type EnsembleWalkerProperties
...
contains
    ...
    end function GetParticleEnsemble
    ...
    end subroutine PropagateEnsemble
...
end module EnsembleWalkerModule